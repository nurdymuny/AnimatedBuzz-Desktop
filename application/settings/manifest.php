...
return array(
  ...
  'package' => array(
    ...
    'changeLog' => array(
      '4.8.7' => array(
        'index.php' => 'Updated code to change minimum PHP version requirement to "5.2.11"',
        'application/settings/manifest.php' => 'Incremented version and updated code to change minimum PHP version requirement to "5.2.11"',
      ),
      '4.6.0' => array(
        'application/index.php' => 'Fixed issue with gzip initialization',
