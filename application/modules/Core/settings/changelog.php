...
return array(
  '4.8.7' => array(
    'Api/Menu.php' => 'Fixed issue with custom menus created from menu editor conflicting with existing menus',
    'Bootstrap.php' => 'Fixed issue with PHP Array files (like en.php) not being created successfully in many cases',
    'controllers/AdminLogController.php' => 'Fixed issue with "Download Log" button in admin Log Browser section not working fine',
    'controllers/AdminMailController.php' => 'Added TinyMCE Editor for editing "Message Body" of Mail Templates',
    'controllers/AdminSettingsController.php' => 'Performed regeneration of PHP Array language files each time when changes are saved in "Performance & Caching" section of administration',
    'Form/Admin/Mail/Templates.php' => 'Added TinyMCE Editor for editing "Message Body" of Mail Templates',
    'Form/Admin/Message/Mail.php' => 'Removed unnecessary TLD check performed at the time of email addresses validation',
    'Form/Admin/Settings/Performance.php' => 'Improved text',
    'Form/Contact.php' => 'Removed unnecessary TLD check performed at the time of email addresses validation',
    'layouts/scripts/default-simple.tpl' => 'Trimmed extra comma (,) coming at the end of meta keywords list',
    'layouts/scripts/default.tpl' => 'Trimmed extra comma (,) coming at the end of meta keywords list',
    'Model/DbTable/Tasks.php' => 'Fixed issue with CURL not working on websites running on SSL (with https)',
    'Model/Link.php' => 'Enabled synchronization of likes and comments, for content posted as attachments from activity feed updates, between the main content and it\'s activity feed',
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'widgets/search/Controller.php' => 'Fixed issue with search widget coming when search is disabled for public users and the search widget is placed on a page that is visible to public users',
  ),
  '4.8.6' => array(
    'Api/Core.php' => 'Fixed bug with Re-Captcha when SSL is enabled',
    'controllers/LinkController.php' => 'Fixed bug with adding link to a wall post where image selector was not being displayed',
    'externals/styles/main.css' => 'Added styles',
    'Form/Admin/Settings/Spam.php' => 'Added a setting for enabling anti-spamming technique in Signup and Login forms',
    'Plugin/Task/Mail.php' => 'Fixed bug with Background Mailer Task which was not getting completed',
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
    'settings/my-upgrade-4.8.5-4.8.6.sql' => 'Added',
    'settings/my.sql' => 'Incremented version',
  ),
  '4.8.5' => array(
    'Controller/Action/Admin.php' => 'Use var_export() instead of serializing arrays manually',
    'controllers/LinkController.php' => 'Fixed multi-byte sites link previewing',
    'layouts/scripts/admin-simple.tpl' => 'Reduced the dependence on _ENGINE_SSL',
    'layouts/scripts/admin.tpl' => 'Reduced the dependence on _ENGINE_SSL',
    ...
    'Model/DbTable/Comments.php' => 'Add the option to sort the comments in reverse chronological order',
    'Model/Item/Abstract.php' => 'Allow for variable length slugs',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'views/scripts/_composeLink.tpl' => 'News feed form attachment links load with the same order',
    'views/scripts/_composeTag.tpl' => 'News feed form attachment links load with the same order',
    'views/scripts/_FancyUpload.tpl' => 'Added restrictions to the file types in the file inputs',
    'views/scripts/admin-files/index.tpl' => 'Fixed a broken link',
    'settings/changelog.php' => 'Incremented version',
  ),
  '4.8.3' => array(
    'externals/styles/admin/main.css' => 'Fixed site-wide statistics chart in Chrome',
    'Controller/Action/Admin.php' => 'Code clean up',
    'controllers/AdminSettingsController.php' => 'Code clean up',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
  ),
  '4.8.2' => array(
    'Bootstrap.php' => 'Select language based on the browser\'s Accept-Language header',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
  ),
  '4.8.1' => array(
    'Form/Admin/Themes/Clone.php' => 'Fix for bug where cloned themes were always the active theme',
    'controllers/AdminThemesController.php' => 'Fix for bug where cloned themes were always the active theme, and manifest file was not correctly set',
    'Form/Admin/Widget/RichText.php' => 'Added a rich text widget',
    'settings/content.php' => 'Added a rich text widget',
    'widgets/rich-text-block' => 'Added a rich text widget',
    'controllers/AdminReportController.php' => 'Check valid content returned by getItem() before using it on Abuse Reports',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
  ),
  '4.8.0' => array(
    'controllers/WidgetController.php' => 'Return 404 for /widget',
    'Plugin/Task/Mail.php' => 'Improve the mail queue robustness',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
  ),
  '4.7.0' => array(
    'Controller/Action/Helper/ContextSwitch.php' => 'Avoid sending duplicate headers',
    'controllers/LinkController.php' => 'Improved compatibility with more sites',
    'externals/images/*' => 'Optimized images',
    'externals/scripts/composer_link.js' => 'Defer script loading',
    'Model/DbTable/Membership.php' => 'Fixed a warning',
    'views/scripts/_composeLink.tpl' => 'Defer script loading',
    'views/scripts/_composeTag.tpl' => 'Defer script loading',
    'settings/my.sql' => 'Incremented version',
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
  ),
  '4.6.0' => array(
    'Api/Mail.php' => 'Emails will fallback to English if a translation is not available',
    'Bootstrap.php' => 'Fixed error caused by incorrect configuration',
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
  ),
