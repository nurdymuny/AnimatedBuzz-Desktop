...
return array(
  '4.8.7' => array(
    'controllers/IndexController.php' => 'Fixed issue with inability of users to like the comments made on activity feeds of a new Forum topic / post',
    'Model/Action.php' => 'Enabled synchronization of likes and comments, for content posted as attachments from activity feed updates, between the main content and it\'s activity feed',
    'Model/Helper/Var.php' => 'Fixed issue with the translation of activity feeds generated for content sharing',
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'View/Helper/ActivityLoop.php' => 'Fixed log errors',
    'views/scripts/_activityText.tpl' => 'Fixed issue with videos uploaded from "My Computer" not being played in activity feeds when HTML5 support is enabled',
    'widgets/feed/Controller.php' => 'Fixed issue with activity feeds getting disappeared randomly in a few cases',
  ),
  '4.8.5' => array(
    'Form/Admin/Settings/General.php' => 'Add the option to sort the comments in reverse chronological order.',
    'Model/Action.php' => 'Add the option to sort the comments in reverse chronological order.',
    'Model/DbTable/Actions.php' => 'removed popup alerts on videos/create',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'settings/changelog.php' => 'Incremented version',
  ),
  '4.8.2' => array(
    'externals/scripts/core.js' => 'Improved backoff for activity feed polling',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
  ),
  '4.8.0' => array(
    'Model/Action.php' => 'Breakage when disabling modules',
    'Model/DbTable/Notifications.php' => 'Breakage when disabling modules',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
  ),
  '4.7.0' => array(
    '/application/languages/en/activity.csv' => 'Fixed a bug',
  ...
  '4.6.0' => array(
    'Model/Action.php' => 'Fixed issue with performance improvement',
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
  ),
  '4.5.0' => array(
    ...
    'externals/scripts/core.js' => 'Fixed style issue with extra container being added in feed commenting ajax',
    'externals/styles/mobile.css' => 'Improved styles',
    'Model/Action.php' => 'Optimized loading of comment likes',
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'views/scripts/_activityText.tpl' => 'Optimized loading of comment likes',
    'widgets/feed/index.tpl' => 'Using placeholder attribute on mobile to fix positioning issues',
  ),
  '4.3.0' => array(
