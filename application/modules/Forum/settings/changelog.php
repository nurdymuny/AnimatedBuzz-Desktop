...
return array(
  '4.8.7' => array(
    ...
    'settings/my.sql' => 'Incremented version and added "iframe" to the list of default tags in the member level settings',
  ),
  '4.8.5' => array(
    'controllers/IndexController.php' => 'Attach and upload media to posts',
    'Form/Post/Create.php' => 'Attach and upload media to posts',
    'Form/Post/Quick.php' => 'Attach and upload media to posts',
    'Form/Topic/Create.php' => 'Attach and upload media to posts',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'views/scripts/index/upload-photo.tpl' => 'Attach and upload media to posts',
    'settings/changelog.php' => 'Incremented version',
  ),
  '4.8.1' => array(
    'controllers/TopicController.php' => 'URL for comment announcements takes you to the same page as the comment',
    'settings/my-upgrade-4.8.0-4.8.1.sql' => 'URL for comment announcements takes you to the same page as the comment',
    'settings/my.sql' => 'Incremented version and URL for comment announcements takes you to the same page as the comment',
    'settings/manifest.php' => 'Incremented version',
    'settings/changelog.php' => 'Incremented version',
  ),
  '4.8.0' => array(
    'controllers/TopicController.php' => 'Fixed Quote button',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'views/scripts/index/index.tpl' => 'Added placeholder',
  ),
  '4.7.0' => array(
    '/application/languages/en/forum.csv' => 'Added phrases',
    'externals/images/*' => 'Optimized images',
    'views/scripts/index/index.tpl' => 'Added a missing translation',
    'settings/my.sql' => 'Incremented version',
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
  ),
  '4.6.0' => array(
    'Plugin/Core.php' => 'Forum activity feed items now use correct privacy settings',
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
  ),
  '4.5.0' => array(
    ...
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'views/scripts/forum/topic-create.tpl' => 'Setting active class on main menu',
    'views/scripts/forum/view.tpl' => 'Setting active class on main menu',
    'views/scripts/topic/post-create.tpl' => 'Setting active class on main menu',
    'views/scripts/topic/view.tpl' => 'Setting active class on main menu',
    'widgets/list-recent-posts/Controller.php' => 'Now correctly checks privacy settings of forum',
    'widgets/list-recent-topics/Controller.php' => 'Now correctly checks privacy settings of forum',
    'widgets/profile-forum-posts/Controller.php' => 'Now correctly checks privacy settings of forum',
    'widgets/profile-forum-topics/Controller.php' => 'Now correctly checks privacy settings of forum',
  ),
  '4.3.0' => array(
    'controllers/ForumController.php' => 'Added new pages to layout editor',
    'settings/changelog.php' => 'Incremented version',
    'settings/install.php' => 'Added new pages to layout editor',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'views/scripts/admin-level/index.tpl' => 'Improved admin panel styles',
    'views/scripts/admin-manage/index.tpl' => 'Improved admin panel styles',
  ),
  '4.2.9' => array(
    'controllers/ForumController.php' => 'Create Forum Search Widget',
    'Form/Search.php' => 'Added',
    'settings/changelog.php' => 'Incremented version',
    'settings/content.php' => 'Create Forum Search Widget',
    'settings/manifest.php' => 'Incremented version',
    'views/scripts/forum/view.tpl' => 'Create Forum Search Widget',
    'views/scripts/index/index.tpl' => 'Create Forum Search Widget',
    'widgets/browse-search/Controller.php' => 'Added',
    'widgets/browse-search/index.tpl' => 'Added',
  ),
  '4.2.8' => array(
    'Form/Post/Quick.php' => 'Added TINYMCE Editor',
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'widgets/list-recent-posts/index.tpl' => 'Added TINYMCE Editor',
  ),
  '4.2.7' => array(
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'widgets/list-recent-posts/index.tpl' => 'Incremented version',
  ),
  '4.2.6' => array(
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
